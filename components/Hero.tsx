...
export default function Hero() {
  ...
  const openWhatsApp = () => {
    ...
    const message = encodeURIComponent(
      "Hi Adil! I found your portfolio and would like to discuss a potential project.",
    );
      ...
      <div className="container mx-auto px-4 py-20 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto leading-relaxed">
            Building tech products from ideation to serving users. Currently
            crafting exceptional digital experiences at Fashol DotCom Limited,
            with a passion for adaptive design and rapid execution.
          </p>
          ...
          <div className="flex justify-center gap-4 mb-8">
            ...
            <Button
              ...
              onClick={() =>
                window.open(
                  "https://www.linkedin.com/in/md-adilur-rashid-418a96171/?originalSubdomain=bd",
                  "_blank",
                )
              }
              className="transition-transform hover:scale-110 bg-white/20 backdrop-blur-sm border-white/30 hover:bg-white/30"
            ...
            <Button
              ...
              size="icon"
              onClick={() =>
                window.open("mailto:adolrashid73@gmail.com", "_blank")
              }
              className="transition-transform hover:scale-110 bg-white/20 backdrop-blur-sm border-white/30 hover:bg-white/30"
            >
              <Mail size={20} />
